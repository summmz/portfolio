...
export function Background() {
  ...
  const b1x = useTransform(gx, (v) => v * 1.4);
  const b1y = useTransform(gy, (v) => v * 1.1);
  const b1r = useTransform(gx, (v) => -v * 0.5);
  const b2x = useTransform(gx, (v) => v * -1.1);
  const b2y = useTransform(gy, (v) => v * 0.9);
  const b2r = useTransform(gx, (v) => v * 0.4);
  const b3x = useTransform(gx, (v) => v * 0.8);
  const b3y = useTransform(gy, (v) => v * -1.2);
  const b3r = useTransform(gy, (v) => v * 0.35);
  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          style={{ x: b1x, y: b1y, rotate: b1r, filter }}
        ...
        <motion.div style={{ x: b2x, y: b2y, rotate: b2r }}>
        ...
        <motion.div style={{ x: b3x, y: b3y, rotate: b3r }}>
